...
module MAGEMinApp
    ...
    include(joinpath(pkg_dir,"src","Classifications/Orthopyroxene_functions.jl"))
    include(joinpath(pkg_dir,"src","Classifications/Muscovite_functions.jl"))
    include(joinpath(pkg_dir,"src","Classifications/Feldspar_functions.jl"))
    include(joinpath(pkg_dir,"src","Classifications/Garnet_functions.jl"))
    include(joinpath(pkg_dir,"src","Classifications/FeTiOxide_functions.jl"))
