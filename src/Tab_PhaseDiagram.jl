                                    ...
                                    dbc_card(dbc_cardbody([
                                        ...
                                        html_div([
                                            dbc_row([
                                                dbc_col([
                                                    dcc_clipboard(
                                                        id          = "phase-assemblage-clipboard-id",
                                                        title       = "copy",
                                                ...
                                                dbc_col([
                                                    dbc_button(     "Clear", id="clear-assemblage-highlight-button", color="light", size="sm", n_clicks=0,
                                                                    style       = Dict(     "display"       => "inline-block",
                                                                                            "marginLeft"    =>  8,
                                                                                            "border"        => "1px grey solid",
                                                                                            "verticalAlign" => "top"    ),
                                            ...
                                            dbc_row([
                                                dbc_card([
                                                    create_assemblage_table(Dict{String,String}[])
                                                ])
                                            ]),
                                    ...
                                    dbc_collapse(
                                        dbc_card(dbc_cardbody([
                                            ...
                                            dbc_row([
                                                ...
                                                dbc_col([
                                                    dcc_dropdown(
                                                        id      = "draw-path-mode-dropdown",
                                                        options = [
                                                            (label = "Phase fractions", value = "phases"),
                                                            (label = "Field profile",   value = "field"),
                                                        ],
                                                        value     = "phases",
                                                        clearable = false,
                                                        style     = Dict("border" => "none"),
                                            ...
                                            ], style = Dict("display" => "none"), id = "draw-path-field-id"),
                                            html_div("‎ "),
                                            dbc_row([
                                                dbc_col([
