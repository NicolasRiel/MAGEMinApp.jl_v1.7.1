                                ...
                                dbc_collapse(
                                    dbc_card(dbc_cardbody([
                                        ...
                                        html_div([
                                            ...
                                            dbc_row([
                                                dbc_col([
                                                    html_h1("Save cumulate TE", style = Dict("textAlign" => "center","font-size" => "120%", "marginTop" => 4)),
                                                ], width=4),
                                                dbc_col([
                                                    dbc_input(
                                                        id      = "Filename-te-cumulate-ptx-id",
                                                        type    = "text",
                                                        style   = Dict("textAlign" => "center") ,
                                                        value   = "filename"   ),
                                                ], width=4),
                                                dbc_col([
                                                    dbc_button("csv file", id="save-te-cumulate-csv-ptx-button", color="light",  n_clicks=0,
                                                    style       = Dict( "textAlign"     => "center",
                                                                        "font-size"     => "100%",
                                                                        "border"        =>"1px grey solid")),
                                                    dbc_tooltip([
                                                        html_div("Save integrated cumulate trace-element composition along the PTX path"),
                                                        html_div("Requires trace elements to be computed first")],target="save-te-cumulate-csv-ptx-button"),
                                                ]),
                                            ]),
                                            dbc_row([
                                                dbc_alert(
                                                    "Successfully saved cumulate trace-element data",
                                                    id      ="data-te-cumulate-csv-ptx-save",
                                                    is_open =false,
                                                    duration=4000,
                                                ),
                                                dbc_alert(
                                                    "Provide a valid filename (without extension)",
                                                    color="danger",
                                                    id      ="data-te-cumulate-save-csv-ptx-failed",
                                                    is_open =false,
                                                    duration=4000,
                                                ),
                                                dbc_alert(
                                                    "Compute trace elements first",
                                                    color="warning",
                                                    id      ="data-te-cumulate-save-csv-ptx-not-computed",
                                                    is_open =false,
                                                    duration=4000,
                                                ),
                                            ]),
                                        ], style = Dict("display" => "none"), id = "te-export-buttons-ptx"),
                            ...
                            dbc_row([
                                ...
                                dbc_card(dbc_cardbody([
                                    ...
                                    html_div([
                                        ...
                                        dbc_row([
                                            dbc_col([ 
                                                html_h1("Starting entropy [kJ/K]", style = Dict("textAlign" => "center","font-size" => "120%",  "marginTop" => 4)),
                                            ]),
                                            dbc_col([ 
                                                dcc_textarea(
                            ...
                            dbc_row([
                                ...
                                dbc_collapse(
                                    dbc_card(dbc_cardbody([
                                        ...
                                        dbc_row([
                                            dbc_col([
                                                html_h1("Phase order", style = Dict("textAlign" => "center","font-size" => "120%", "marginTop" => 8)),
                                            ], width=6),
                                            dbc_col([
                                                dbc_button("Modify phase order",id="button-phase-order-ptx", color="light",  n_clicks=0,
                                                style       = Dict( "textAlign"     => "center",
                                                                    "font-size"     => "100%",
                                                                    "border"        =>"1px grey solid",
                                                                    "width"         => "100%" )),
